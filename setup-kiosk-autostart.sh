...
echo -e "${BLUE}╔════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   GoldenMunch POS Kiosk Autostart Setup Script       ║${NC}"
echo -e "${BLUE}║   For Raspberry Pi with Wayland/Labwc                 ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
echo ""
...
echo "  1. System Options → Boot / Auto Login"
...
echo "  • $HOME_DIR/stop-kiosk.sh"
echo "  • $HOME_DIR/restart-kiosk.sh"
echo "  • $HOME_DIR/view-kiosk-logs.sh"
echo "  • $HOME_DIR/.config/labwc/autostart"
echo "  • $HOME_DIR/.config/systemd/user/goldenmunch-kiosk.service"
echo ""

echo -e "${BLUE}Quick Commands:${NC}"
echo "  • Test kiosk manually:    ./start-kiosk.sh"
echo "  • Stop kiosk:             ./stop-kiosk.sh"
echo "  • Restart kiosk:          ./restart-kiosk.sh"
echo "  • View logs:              ./view-kiosk-logs.sh"
echo "  • Check service status:   systemctl --user status goldenmunch-kiosk"
echo ""
...
echo "  • ~/frontend-output.log"
echo "  • ~/chromium-output.log"
echo ""
