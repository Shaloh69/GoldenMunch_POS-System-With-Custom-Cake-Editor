  ...
  const handleUpdateStatus = async (newStatus: OrderStatus) => {
    ...
    if (
      ...
      setStatusUpdateError(
        "⚠️ Payment must be verified before processing this order. Please verify the payment first.",
      );
    ...
    if (newStatus === "completed" && selectedOrder.order_status !== "ready") {
      setStatusUpdateError(
        "⚠️ Order must be ready before it can be completed. Please mark it as ready first.",
      );
                  ...
                  <div className="mb-4 bg-warning-50 border-2 border-warning-300 p-4 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-warning-700">
                        This order must be paid/verified before you can start
                        preparing it. Click "Verify Payment" below to confirm
                        payment.
                      </p>
                    </div>
                  </div>
                ...
                <Tabs aria-label="Order details tabs">
                  <Tab key="details" title="Details">
                    <div className="space-y-4 pt-4">
                      ...
                      <div>
                        <p className="text-sm text-default-500 mb-2 font-semibold">
                          Items
                        </p>
                        {selectedOrder.items?.map((item, idx) => (
                          <div
                            key={idx}
                            className="flex justify-between p-3 bg-default-50 rounded mb-2"
                          >
                            <div>
                ...
                <div className="flex gap-2">
                  {selectedOrder.order_status === "pending" && (
                    <Button
                      ...
                      isLoading={updating}
                      onPress={() =>
                        handleUpdateStatus("confirmed" as OrderStatus)
                      }
                    >
                      Confirm Order
                    </Button>
                  ...
                  {selectedOrder.order_status === "confirmed" && (
                    <Button
                      ...
                      isLoading={updating}
                      onPress={() =>
                        handleUpdateStatus("preparing" as OrderStatus)
                      }
                    >
                      Start Preparing
                    </Button>
                  ...
                  {selectedOrder.order_status === "ready" && (
                    <Button
                      ...
                      isLoading={updating}
                      onPress={() =>
                        handleUpdateStatus("completed" as OrderStatus)
                      }
                    >
                      Complete Order
                    </Button>
        ...
        <ModalContent>
            ...
            {selectedOrder && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Chip className="uppercase" color="primary" size="lg">
                    {selectedOrder.payment_method}
                  </Chip>
                </div>
                ...
                {(selectedOrder.payment_method === "credit_card" ||
                  ...
                  <div className="bg-warning-50 p-3 rounded">
                    <p className="text-sm text-warning-700">
                      Verify that the card payment was successfully processed
                      through your POS terminal.
                    </p>
                  </div>
                )}
                ...
                {selectedOrder.payment_method === "cash" && (
                  <div className="bg-success-50 p-3 rounded">
                    <p className="text-sm text-success-700">
                      ...
                      {Number(selectedOrder.final_amount || 0).toFixed(2)} in
          ...
          <ModalFooter>
            ...
            <Button
              ...
              startContent={
                !verifyingPayment && <CheckCircleIcon className="h-5 w-5" />
              }
